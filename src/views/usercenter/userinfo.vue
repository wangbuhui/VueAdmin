<template>
  <div>
    <Card>
      <tables ref="tables" editable searchable :border="false" size="small" search-place="top" v-model="stores.user.data" :totalCount="stores.user.query.totalCount" :columns="stores.user.columns" @on-delete="handleDelete" @on-edit="handleEdit" @on-select="handleSelect"
        @on-selection-change="handleSelectionChange" @on-refresh="handleRefresh" :row-class-name="rowClsRender" @on-page-change="handlePageChanged" @on-page-size-change="handlePageSizeChanged" @on-assign="handleAssignRole">
        <div slot="search">
          <section class="dnc-toolbar-wrap">
            <Row :gutter="16">
              ...
              <Form inline @submit.native.prevent>
                <FormItem>
                  <Input type="text" search :clearable="true" v-model="stores.user.query.kw" placeholder="输入关键字搜索..." @on-search="handleSearchUser()">
                  <Select slot="prepend" v-model="stores.user.query.isDeleted" @on-change="handleSearchUser" placeholder="删除状态" style="width:60px;">
                          <Option
                  ...
                  <Select slot="prepend" v-model="stores.user.query.status" @on-change="handleSearchUser" placeholder="用户状态" style="width:60px;">
                          <Option
              ...
              <ButtonGroup class="mr3">
                <Button class="txt-danger" icon="md-trash" title="删除" @click="handleBatchCommand('delete')"></Button>
                <Button class="txt-success" icon="md-redo" title="恢复" @click="handleBatchCommand('recover')"></Button>
                <Button class="txt-danger" icon="md-hand" title="禁用" @click="handleBatchCommand('forbidden')"></Button>
                <Button class="txt-success" icon="md-checkmark" title="启用" @click="handleBatchCommand('normal')"></Button>
    ...
    <Drawer title="用户角色分配" v-model="formAssignRole.opened" width="500" :mask-closable="true" :mask="true">
      <Form>
        <FormItem>
          <Transfer :data="formAssignRole.roles" :target-keys="formAssignRole.ownedRoles" :render-format="renderOwnedRoles" :titles="['未获得的角色','已获得的角色']" @on-change="handleChangeOwnedRolesChanged"></Transfer>
        </FormItem>
      </Form>
